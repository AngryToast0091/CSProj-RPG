...
namespace ClassLibrary.Monster_Subclasses
{
    internal class Goblin : Monster
    {
        ...
        #region Constructors
        //----------------------------------- Constructors-----------------------------------
        public Goblin(string name, int maxHP, int dmg) : base(name, maxHP, dmg) => InitializeLootPool();

        public Goblin(string name, int maxHP, int dmg, int level) : base(name, maxHP, dmg, level) => InitializeLootPool();
